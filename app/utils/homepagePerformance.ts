...
export const HERO_IMAGES = [
  {
    src: 'https://vietnhatplastic.com/Data/Sites/1/Banner/vn_banner_web_t12_25-04.png',
    alt: 'Banner Việt Nhật Plastic — Bộ sưu tập',
    label: 'Bộ sưu tập',
    desktopSizes: '(max-width: 767px) 100vw, 33vw',
    mobileSizes: '100vw',
    nuxtDesktopSizes: 'xs:100vw md:33vw',
    nuxtMobileSizes: 'xs:100vw',
  },
  {
    src: 'https://vietnhatplastic.com/Data/Sites/1/Banner/vn_banner_web_t12_25-01.png',
    alt: 'Banner Việt Nhật Plastic — Sản phẩm mới',
    label: 'Sản phẩm mới',
    desktopSizes: '(max-width: 767px) 100vw, 33vw',
    mobileSizes: '100vw',
    nuxtDesktopSizes: 'xs:100vw md:33vw',
  ...
  {
    src: 'https://vietnhatplastic.com/Data/Sites/1/Banner/vn_banner_web_t12_25-02.png',
    alt: 'Banner Việt Nhật Plastic — Chất lượng',
    label: 'Chất lượng',
    desktopSizes: '(max-width: 767px) 100vw, 33vw',
    mobileSizes: '100vw',
    nuxtDesktopSizes: 'xs:100vw md:33vw',
